...
router.get('/user/events_created', authMiddleware('jwt'), eventController.getUserEvents);
router.get('/user/events_registered', authMiddleware('jwt'), eventController.getRegisteredEvents);
